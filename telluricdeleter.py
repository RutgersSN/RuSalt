## Run anywhere using python telluricdelter.py
## First input is directory path. Second input is the name of the spectra fits file you wish
## to remove the telluric lines from. 
## It is better not to hardcode the telluric waves, in lines 39. 
## It will take whatever file you give it and output the file realfinal.fits
...
## Spectrum regions that contain telluric lines
